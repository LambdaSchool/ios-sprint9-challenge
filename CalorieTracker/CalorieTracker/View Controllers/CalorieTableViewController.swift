...
class CalorieTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "Calories: \(calorieIntake.calorieAmount)"
    ...
    @IBAction func addIntake(_ sender: Any) {
        let alert = UIAlertController(title: "Add calories?", message: "Enter the amount of calories you consumed today", preferredStyle: .alert)
    ...
    private func add(calorieCount: String) {
        ...
        Calorie(calorieAmount: calories)
        save()
    }
    ...
    @objc private func updateChart() {
        ...
        calorieIntakes?.forEach { caloriesArray.append(Double($0.calorieAmount)) }
