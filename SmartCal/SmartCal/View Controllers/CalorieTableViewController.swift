...
class CalorieTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "ChartEmbedSegue" {
            
            guard let destVC = segue.destination as? ChartViewController else {return}
            destVC.fetchedResultsController = fetchedResultsController
