...
class WaterController {
    ...
    private enum LoginStatus {
        ...
        static var isLoggedIn: Self {
            if let bearer = WaterController.bearer {
    ...
    private let baseURL = URL(string: "https://plant-care-reminder.herokuapp.com/api")!
    ...
    private func updatePlant(plant: Plant, plantRepresentation: PlantRepresentation) {
        ...
        plant.plantName = plantRepresentation.plantName
